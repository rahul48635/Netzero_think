    ...
    >
      ...
      <div className="flex flex-col max-h-full items-center justify-around gap-5">
        ...
        <motion.button
          ...
          onClick={() =>
            window.open(
              `mailto:support@netzerothink.com?subject=New Service Request from [Name]&body=Name: [Name]%0APhone: [WhatsApp Number]%0AOrganistion: [Your Org]%0ADesignation: [Your Designation]%0ALinkedIn: [Link]%0ADescription: [Why do you want to Join?]`
            )
          }
        >
          Join Our Community
        ...
        <motion.button
          ...
          whileTap={{ scale: 1.2 }}
          onClick={() =>
            window.open("https://www.linkedin.com/company/net-zero-think/")
          }
        >
          LinkedIn
        </motion.button>
