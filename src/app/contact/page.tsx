...
export default function ContactPage() {
  ...
  const handleWhatsApp = () => {
    const message = encodeURIComponent(
      "Hi! I'm interested in your NET ZERO solutions. Please get back to me.",
    );
    window.open(`https://wa.me/+918240615694?text=${message}`, "_blank");
  };
  const truncate: (text: string, max: number) => string = (text, max = 25) =>
    text.length > max ? text.slice(0, max) + "..." : text;

  return (
    <div className="min-h-screen min-w-screen bg-[url('/bg-cover/meeting.webp')] bg-center bg-fixed bg-cover bg-no-repeat relative">
      ...
      <section className="relative py-20 px-4 text-center text-blue-800 mt-30 sm:mt-50">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">
            “If Reaching ‘NET ZERO’ Is Your Ultimate Goal, We’re There To Make
            This Journey Memorable And Remarkable”.
          </h1>
          <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 inline-block">
            <p className="text-lg opacity-90 text-white">
              Tell us about your business requirements, we will get back to you
              as soon as possible.
            </p>
          </div>
        </div>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription className="text-blue-800 font-bold">
                    Share your business requirements and let&apos;s start your
                    NET ZERO journey.
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="company" className="text-green-500">
                          Company Name
                        </Label>
                        <Input
                          id="company"
                    ...
                    <div className="space-y-2 max-w-full">
                      <Label className="text-green-500">
                        FOR QUESTIONS OR QUOTES - Select a solution
                      </Label>
                      <Select
                      ...
                      >
                        <SelectTrigger className="text-blue-800 max-w-full">
                          <SelectValue placeholder="Choose a solution">
                            {formData.solution
                              ? truncate(formData.solution, 30)
                              : ""}
                          </SelectValue>
                        </SelectTrigger>
                        <SelectContent className="text-blue-800 w-[80%]">
                          <SelectItem value="Emissions Measurement, Reporting & Verification (MRV)">
                            Emissions Measurement, Reporting & Verification
                            (MRV)
                          </SelectItem>
                          <SelectItem value="Greenhouse Gas (GHG) Accounting & Carbon Footprint Analysis">
                            Greenhouse Gas (GHG) Accounting & Carbon Footprint
                            Analysis
                          </SelectItem>
                          <SelectItem value="Climate & Environmental Policy Advisory">
                            Climate & Environmental Policy Advisory
                          </SelectItem>
                          <SelectItem value="Environmental Credits & Sustainability Finance Advisory">
                            Environmental Credits & Sustainability Finance
                            Advisory
                          </SelectItem>
                          <SelectItem value="ESG Strategy & Reporting">
                            ESG Strategy & Reporting
                          </SelectItem>
                          <SelectItem value="Capacity Building & Professional Training">
                            Capacity Building & Professional Training
                          </SelectItem>
                          <SelectItem value="Green Staffing Solution">
                            Green Staffing Solution
                          </SelectItem>
                          <SelectItem value="Life Cycle Assesment (LCA)">
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="message" className="text-green-500">
                    ...
                    <Button
                      ...
                      onClick={() =>
                        window.open(
                          `mailto:support@netzerothink.com?subject=New Service Request from ${formData.name}&body=Name: ${formData.name}%0APhone: ${formData.phone}%0AOrg: ${formData.company}%0AEmail: ${formData.email}%0AService: ${formData.solution}%0AService: ${formData.message}`,
                        )
                      }
                    >
                      Submit
                  ...
                  <div className="flex flex-col gap-10 sm:flex-row items-center space-x-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-green-600 text-sm">
                        Get instant support and quick quotes
                      </p>
                    </div>
                    <Button
            ...
            <div className="space-y-8">
                  ...
                  <div className="flex items-start space-x-3 text-left">
                    ...
                    <div>
                      ...
                      <p className="text-blue-800">
                        For Solutions & Services{" "}
                        <b> - support@netzerothink.com</b>
                      </p>
                      <p className="text-blue-800">
                        For Training & Capacity Building{" "}
                        <b> - academia@netzerothink.com</b>
                      </p>
                    </div>
                  </div>
                </CardContent>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription className="text-blue-800">
                    Visit our office in Jayanagar, Bengaluru
                  </CardDescription>
                </CardHeader>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl mb-8 opacity-90 text-white">
            Let&apos;s work together to create a sustainable future for your
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button
              size="lg"
              variant="secondary"
              className="cursor-pointer text-green-500 hover:bg-gray-300 hover:text-blue-500 bg-gray-200"
              onClick={handleWhatsApp}
            >
