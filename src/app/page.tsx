...
export default function Home() {
  ...
  return (
    <div className="relative min-h-screen w-full flex flex-col items-center justify-center overflow-hidden  ">
      {/* Hero Section */}
      <section
        className="w-full flex flex-col items-center justify-center px-4  text-center relative  sm:static sm:bottom-0 bg-[url('/bg-cover/hero.webp')] bg-center bg-fixed bg-cover bg-no-repeat mask-b-from-99% "
        ref={ref}
      >
      ...
      <section
        className="relative w-full flex flex-col items-center justify-center py-16 px-4 bg-[url('/bg-cover/corp.webp')] bg-bottom bg-fixed bg-cover bg-no-repeat mask-t-from-99%"
        ref={ref}
      >
        <div className="absolute inset-0 bg-black/30 -z-10"></div>
        ...
        <div className="w-full text-center ">
          ...
          {inView && <Cards services={services} />}
        </div>
